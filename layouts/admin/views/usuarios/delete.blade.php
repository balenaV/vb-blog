<div class="modal" id="confirmDeleteModal" tabindex="-1">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form id="deleteForm" method="POST" action="{{ app\Core\Helpers::url('admin/usuarios/delete/') }}">
                <input type="hidden" name="id" id="id">

                <div class="modal-body text-center py-4">
                    <h3>Você tem certeza?</h3>
                    <div class="text-secondary">
                        Você tem certeza que deseja remover este Usuário? Essa ação não poderá ser desfeita.
                    </div>
                </div>
